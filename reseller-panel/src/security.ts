/**
 * LegitX V2 — Reseller Panel Security Module
 *
 * Provides: rate limiting, input sanitization, session management,
 * secure error handling, and reseller-specific protections.
 */
...
const SESSION_TIMEOUT_MS = 3 * 60 * 60 * 1000; // 3 hours for resellers
const SESSION_KEY = "legitx_reseller_session_start";
const ACTIVITY_KEY = "legitx_reseller_last_activity";
